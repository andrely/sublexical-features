...
class CirrusDumpIter():
    def __init__(self, dump_fn, limit=None, tokenizer=None):
    ...
    def __iter__(self):
        ...
        return ([token for token in tokenizer(art['text'])]
                for art in articles(self.dump_fn, limit=self.limit))
